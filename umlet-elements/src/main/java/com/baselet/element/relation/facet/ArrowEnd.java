...
abstract class ArrowEnd implements RegexValueHolder
{
    ...
    static ArrowEnd RIGHT_DOTTED = new ArrowEnd("oo")
    {
        @Override
        public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject)
        {
            PointDouble point = lineToDraw.getPointOnLineWithDistanceFrom(drawOnLineStart, RelationDrawer.DOT_RADIUS);
            drawer.setBackgroundColor(new ColorOwn(0, 0, 0, Transparency.FOREGROUND));
            RelationDrawer.drawCircle(point, RelationDrawer.DOT_RADIUS, drawer, lineToDraw, drawOnLineStart, resizableObject, null, false);
        }
    };
    ...
    static ArrowEnd RIGHT_NORMAL_DOTTED = new ArrowEnd(">o")
    {
        @Override
        public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject)
        {
            ...
            drawer.setBackgroundColor(new ColorOwn(0, 0, 0, Transparency.FOREGROUND));
            RelationDrawer.drawCircle(point, RelationDrawer.DOT_RADIUS, drawer, lineToDraw, drawOnLineStart, resizableObject, null, false);
            point = lineToDraw.getPointOnLineWithDistanceFrom(drawOnLineStart, RelationDrawer.DOT_RADIUS * 2);
            RelationDrawer.drawArrowToLine(point, drawer, lineToDraw, drawOnLineStart, ArrowEndType.NORMAL, false, false);
        }
    };
