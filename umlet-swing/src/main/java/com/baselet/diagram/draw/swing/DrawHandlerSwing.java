...
public class DrawHandlerSwing extends DrawHandler
{
    ...
    /**
     * Java Swing JComponents have a width of w, but only w-1 pixels are
     * drawable
     * Therefore to draw a rectangle around the whole element, you must call
     * g.drawRect(0,0,w-1,h-1)
     * To avoid this displacement pixel at every draw method, this method
     * ensures you can never draw outside of the right component border
     * x is also important for width drawings which don't start at 0 (e.g.
     * Deployment "3-dimensional" Rectangle)
     */
